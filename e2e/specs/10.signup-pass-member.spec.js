describe('Sign Up Member with Passes By Coordinator', function () {
    var memberOptions = {
        membershipType: 'Laptop Lounge',
        membershipPlan: 'Unlimited Lounge',
    ...
    afterAll(function() {
        if (browser.params.save) {
            sandboxApi.storeTestData('10-pass-member');
        }
        login.page.signout();
    });

    beforeEach(function() {
        sandboxApi.loadTestData('09-pass-setup');
